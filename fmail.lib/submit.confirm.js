...
//画像ボタン利用時
document.write('<input type="button" id="submit_confirm" class="submit_confirm_button" value="送　信　！" title="送　信　！" onclick="fmail_sending(this.form)" onkeypress="fmail_sending(this.form)" />');
